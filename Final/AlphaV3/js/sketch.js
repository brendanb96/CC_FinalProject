...
// + Timer Object For Alerts
// --- How Long Alert Lasts On Screen
var alertTimer;
// --- How Long Before It Reappears or "Flashes"
var flashTimer;
...
{
  // + Canvas Variables
  // --- Canvas Size (500x500 for Convenience), However Sketch is Scalable by Square (Width = Height)
  ...
  // + Calculate Menu Image Size
  menuImgSize = width / 4.5;
  ...
  rapperList[ 1 ] = new Rapper( 2, name2, menuimg2, menuImgSize, artimg2, song2, quoteLines2, songLyrics2, 87250 );
  ...
  // --- Create Timer Object For Alerts
  // --- How Long Alert Lasts On Screen
  alertTimer = new Timer( 3500 );
  alertTimer.start();

  // --- How Long Before It Reappears or "Flashes"
  flashTimer = new Timer( 1750 );
}
...
function draw()
{
  ...
  // + Get The Level of Audio Input
  var recLevel = getInputLevel();
  ...
  // --- If It Is Draw State 2 But No Song is Playing, The Drawing is "Over"
  // NOTE: Was "Buggy" When Inside State Check If Statements for Draw State
  // ... Moved Outside of Those Statements to Allow More Processing Time Between Two Functions
  if( !rapperList[ rapperSelection ].song.isPlaying() && drawState == 2 )
  {
    sketchReset();
  }
}

function makeAlert( num )
{
	var txt = 'Press ' + num;
	fill( 40, 200, 200 );
