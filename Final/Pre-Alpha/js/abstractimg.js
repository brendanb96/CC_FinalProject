...
function AbstractImg( typeID, theImg, imgScale, inputLyrics )
{
  ...
  this.loadLyricData = function()
  {
    ...
    // --- EXTRA NOTE: Original Length is Needed Because as More Blank Rows are Addded,
    // --- The Larger the Array Gets, and Can Risk an Infinite Loop
  ...
  this.display = function( level )
  {
    ...
    var allAlphaValues = calcAlphaValues( level );
  ...
  this.calcAlphaValues = function( level )
  {
    ...
    // QUICK NOTE: Though 0.1 Is Not Even Half of 1.0, Here Is Is Considered Large
    ...
    else
    {
      ...
      // + If Logo Alpha Value is Less Than 100, Make It Transparent
      if( logoalphVal < 100 )
      {
        logoalphVal = 0;
      }
