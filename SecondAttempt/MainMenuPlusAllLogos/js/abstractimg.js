...
function AbstractImg( typeID, theImg, imgScale, inputLyrics )
{
  ...
  this.display = function( level )
  {
    ...
    //var logoalphVal = 255 - alphVal;
        //if( logoalphVal < 100 )
        //{
         // logoalphVal = 0;
        //}
    //var lyricalphVal = 255 - logoalphVal;
      
        //console.log( "aaaa:" + lyricalphVal );
    ...
    for( var y = 0; y < 50; y++ )
    {
      for( var x = 0; x < 50; x++ )
      {
        ...
        this.displayText( xPos, yPos, this.iScale, brightness, lyricalphVal, this.charArray[ counter ], clrCount );
                counter++;
      }
    }
  }
  ...
  this.displayText = function( xPos, yPos, size, clr, alphVal, txt, val )
    {
        // size = max
